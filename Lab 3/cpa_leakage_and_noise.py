...
self.ppmod[0].noise = 0.09  # (sum of group members last Spire ID + 1) / (# group members * 100)
self.ppmod[0].enabled = True  # enable noise

attack = CPA()
leak_model = AES128_8bit(LastroundStateDiff) # Last Round State key leakage
